...
challenge import has been exercised.

## Deterministic and isolated checks

`bash .yukon/setup.sh` discovers 212 tests: 208 credential-free tests pass and
four explicit Docker integration tests are skipped by default. The test suites
