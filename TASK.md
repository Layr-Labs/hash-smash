...
[AGENTS.md](./AGENTS.md), [FRONTIER_LANES.md](./FRONTIER_LANES.md), and your assigned
...
track's contract. [CANDIDATE_QUALIFICATION.md](./CANDIDATE_QUALIFICATION.md) explains
readiness; [JUDGE_LANES.md](./JUDGE_LANES.md) defines acceptance and
[HEURISTIC_EXPERIMENTS.md](./HEURISTIC_EXPERIMENTS.md) defines optional isolated
...
Follow [YUKON_SOLVER_GUIDE.md](./YUKON_SOLVER_GUIDE.md) for the complete setup, run,
