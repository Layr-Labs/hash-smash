...
the leaf manifests explicitly reach the shared organizer code. The root schema-v1
manifest and pilot workflow remain intact. Source inspected: Yukon master
